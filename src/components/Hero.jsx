...
const Hero = () => {
    return (
        <MyContainer containerId='hero' containerStyle='md:my-20 max-md:mb-20 flex justify-between items-center max-xl:flex-col-reverse gap-8'>
            ...
            <img src={komputer} alt="" className='md:w-[25rem]' />
        </MyContainer>
    )
}
export default Hero