    ...
    return (
        <div className="py-[8rem]" id="about">
            <div className="grid grid-cols-[17rem,auto]">
                <div className="text-5xl leading-snug border-r-[2px] border-black">Apa sih itu Clubbing?</div>
                <div className="text-xl grid place-items-center pl-12">Clubbing merupakan ekstrakurikuler di SMKN 1 Kota Bekasi, dimana para siswa berkumpul dalam mendalami dunia pemrograman. Ini adalah klub yang menyediakan platform bagi siswa untuk belajar, berlatih, dan berkolaborasi dalam berbagai proyek dan aktivitas coding.</div>
            </div>
